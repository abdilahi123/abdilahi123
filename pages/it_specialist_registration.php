<?php
require '../handler/rSpecialist.php';
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="card card-success p-5 shadow">
                        <form id="it-specialist-registration-form" action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="experience" name="expirience">
                                    </div>
